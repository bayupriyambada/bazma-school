@section('pageTitle', 'Create Information - SMK TI BAZMA')
<div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body" wire:ignore>
                                ...
                                <input id="description" type="text" wire:model.defer="description" class="form-control @error('description') is-invalid @enderror"
                                    name="example-text-input" placeholder="Eg: MK001">
                                @error('description')
                    ...
                    {{-- <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <label class="form-label required">Description</label>
                                <div wire:ignore>
                                    <textarea cols="10" style="height: 200px;" wire:model.defer="description" class="form-control" name="description"
