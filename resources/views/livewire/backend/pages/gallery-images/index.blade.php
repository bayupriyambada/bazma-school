@section('pageTitle', 'Gallery Images - SMK TI BAZMA')
<div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex">
                        <a href="{{ route('pages.gallery.images.create') }}" class="btn btn-primary ms-auto">Add New
                            Data</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary w-100" target="_blank"
                                            href="{{ Storage::url($item->picture) }}">Click
                                            Link Picture</a>
                                    </td>

                                    <td class="text-end">
                                        <a class="btn btn-yellow btn-icon"
                                            href="{{ route('pages.gallery.images.edit', $item->uuid) }}">Edit</a>
